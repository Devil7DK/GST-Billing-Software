...
#Region "Events"
        Private Sub btn_DeliveryChallan_Click(sender As Object, e As EventArgs) Handles btn_DeliveryChallan.Click
            ...
            Dim Items As New List(Of Classes.Invoices.DeliveryChallan.Item)({
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(1, "Item1", "7488", Classes.Objects.Units.GetAllUnits(10)), 8, 0, 50),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(2, "Item2", "7488", Classes.Objects.Units.GetAllUnits(10)), 6, 0, 45),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(3, "Item3", "7488", Classes.Objects.Units.GetAllUnits(10)), 9, 0, 35),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(4, "Item4", "7488", Classes.Objects.Units.GetAllUnits(10)), 5, 0, 15),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(5, "Item5", "7488", Classes.Objects.Units.GetAllUnits(10)), 10, 0, 10),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(6, "Item6", "7488", Classes.Objects.Units.GetAllUnits(10)), 5, 0, 50),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(1, "Item1", "7488", Classes.Objects.Units.GetAllUnits(10)), 8, 0, 50),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(2, "Item2", "7488", Classes.Objects.Units.GetAllUnits(10)), 6, 0, 45),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(3, "Item3", "7488", Classes.Objects.Units.GetAllUnits(10)), 9, 0, 35),
                                                                        New Classes.Invoices.DeliveryChallan.Item(New Classes.Objects.Good(4, "Item4", "7488", Classes.Objects.Units.GetAllUnits(10)), 5, 0, 15),
